...
- (void)setupTopViews {
    ...
    backButton.frame = CGRectMake(4, StatusBarHeight, 60, 44);
    ...
    nextButton.frame = CGRectMake(ScreenWidth-60-4, StatusBarHeight, 60, 44);
    [nextButton setTitle:NSLocalizedString(@"发布", nil) forState:(UIControlStateNormal)];
